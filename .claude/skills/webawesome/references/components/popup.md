...
<script type="module">
  ...
  const placement = container.querySelector('wa-select[name="placement"]');
...
<div class="popup-placement">
  ...
  <wa-select name="placement" label="Placement" placeholder="Select placement..."></wa-select>
</div>
...
<script type="module">
  ...
  const popup = container.querySelector('wa-popup');
  const placement = container.querySelector('wa-select');
...
<div class="popup-border">
  ...
  <style>
    ...
    .popup-border-options wa-select {
      width: 160px;
    }
  </style>
